...
void testDefaultProjectProjects( 
  ...
  group("Testing Default.Project.Project", () { 
    ...
    test("Update project id without try", () { 
      ...
      expect(() => randomProject.name = 'service', throws); 
    ...
    test("Update project id with success", () { 
      ...
      var entity = projects.singleWhereAttributeId("name", 'lifespan'); 
      expect(entity, isNotNull); 
      expect(entity.name, equals('lifespan')); 
    ...
    test("Update project non id attribute with failure", () { 
      var randomProject = projects.random(); 
      var afterUpdateEntity = randomProject.copy(); 
      afterUpdateEntity.description = 'milk'; 
      expect(afterUpdateEntity.description, equals('milk')); 
    ...
    test("Project update undo and redo", () { 
      ...
      var action = new SetAttributeAction(session, project, "description", 'message'); 
      action.doit(); 
    ...
    test("Reactions to project actions", () { 
      ...
      var setAttributeAction = new SetAttributeAction( 
        session, project, "description", 'revolution'); 
